    ...
    <View className="bg-white flex-1">
      ...
      <View style={{backgroundColor: themeColors.bgColor(0.2)}}
        className="flex-row px-4 items-center">
          <Image source={require('../assets/images/deliveryman.png')} className="w-20 h-20 rounded-full"/>
              ...
              return(
                <View key={key}
                  className='flex-row items-center space-x-3 py-2 px-4 bg-white rounded-3xl mx-2 mb-3 shadow-md'>
                    <Text className='font-bold mr-3 ' style={{color: themeColors.text}}>
                      {items.length} x
                    </Text>
                    <Image className="h-14 w-14 rounded-full mr-3" source={{ uri: dish.imageUrl }} />
